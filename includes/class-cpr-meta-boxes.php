...
class CPR_Meta_Boxes {
    ...
    public function render_meta_box($post) {
        ...
        ?>
        <p>
            <label for="cpr_rating"><?php esc_html_e('Star Rating (1-5)', 'amrrev-product-reviews-for-woocommerce'); ?></label><br>
            <input type="number" id="cpr_rating" name="cpr_rating" min="1" max="5" value="<?php echo esc_attr($rating); ?>" />
        </p>

        <p>
            <label for="cpr_age_range"><?php esc_html_e('Age Range', 'amrrev-product-reviews-for-woocommerce'); ?></label><br>
        ...
        <p>
            <label for="cpr_file"><?php esc_html_e('Upload File (JPG, PNG, PDF)', 'amrrev-product-reviews-for-woocommerce'); ?></label><br>
