    ...
    <ul class="subsubsub">
        <li>
            ...
            class="<?php echo $status === 'pending' ? 'current' : ''; ?>">
                <?php esc_html_e( 'Pending', 'revwoo-product-reviews' ); ?> 
        ...
        <li>
            ...
            class="<?php echo $status === 'publish' ? 'current' : ''; ?>">
                <?php esc_html_e( 'Approved', 'revwoo-product-reviews' ); ?> 
        ...
        <li>
            ...
            class="<?php echo $status === 'draft' ? 'current' : ''; ?>">
                <?php esc_html_e( 'Rejected', 'revwoo-product-reviews' ); ?> 
                    ...
                    <td width="15%">
                        <?php if ( $status === 'pending' ) : ?>
                            <button class="button button-small cpr-approve-btn" 
                                ...
                                <img src="<?php echo esc_url( CPR_ASSETS_URL . 'images/approve.svg' ); ?>" 
                                    alt="<?php esc_attr_e( 'Approve', 'revwoo-product-reviews' ); ?>"> 
                                <?php esc_html_e( 'Approve', 'revwoo-product-reviews' ); ?>
                            </button><br>
                            <button class="button button-small cpr-reject-btn" 
                                    data-review-id="<?php echo esc_attr( $review_id ); ?>" 
                                    style="margin-top: 5px;">
                                <img src="<?php echo esc_url( CPR_ASSETS_URL . 'images/reject.svg' ); ?>" 
                                    alt="<?php esc_attr_e( 'Reject', 'revwoo-product-reviews' ); ?>"> 
                                <?php esc_html_e( 'Reject', 'revwoo-product-reviews' ); ?>
                            </button>
                        ...
                        <button class="button button-link-delete button-small cpr-delete-btn" 
                            ...
                            <img src="<?php echo esc_url( CPR_ASSETS_URL . 'images/delete.svg' ); ?>" 
                                alt="<?php esc_attr_e( 'Delete', 'revwoo-product-reviews' ); ?>"> 
                            <?php esc_html_e( 'Delete', 'revwoo-product-reviews' ); ?>
                        </button>
                    </td>
                </tr>
                <?php endwhile; ?>
        ...
        <?php
          ...
          <div class="cpr-no-reviews">
                <p style="padding: 40px; text-align: center; color: #666;">
                    <?php esc_html_e( 'No reviews found with this status.', 'revwoo-product-reviews' ); ?>
                </p>
            </div>
        <?php endif; ?>
    </div>
